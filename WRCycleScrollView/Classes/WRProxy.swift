...
public extension PageControlAlimentProtocol where Self : UIView
{   // TODO: 等待优化
    func relayoutPageControl(pageControl: WRPageControl)
    {
...
public protocol EndlessScrollProtocol
{
    /////////////////////////////////
    /// 是否自动滚动
...
public extension EndlessScrollProtocol where Self : UIView
{
